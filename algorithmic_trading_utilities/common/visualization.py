"""
Visualization utilities for algorithmic trading.

This module provides broker-agnostic plotting and visualization functions
for portfolio analysis and performance metrics.
"""
...
def plot_time_series(df):
    ...
    Args:
        df (pd.DataFrame): DataFrame with time series data to plot
    """

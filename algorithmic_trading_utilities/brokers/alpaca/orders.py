...
def get_current_trailing_stop_orders():
    ...
    """
    # Filtering by active SELL orders. This isn't ideal when it comes to short selling.
    # Trailing stop orders ids may have to be recorded somewhere when placed
...
def get_orders_to_cancel():
    ...
    """
    order_ids = {order.id for order in get_open_orders()}

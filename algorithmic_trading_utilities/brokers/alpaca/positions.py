"""
Alpaca position management module.

This module provides functions to manage positions, track open positions,
and handle position closure based on various criteria.
"""
...
def get_all_positions():
    """
    Retrieve and return a list of open positions with their symbols, quantities, and corresponding buy/sell sides.
    Adjust the side mapping based on the position's side ('long' or 'short').

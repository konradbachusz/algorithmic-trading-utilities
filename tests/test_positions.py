...
import pytest
from brokers.alpaca.positions import (
    get_open_positions,
...
class TestGetOpenPositions:
    ...
    def test_get_open_positions_success(self, mocker):
        ...
        mocker.patch(
            "brokers.alpaca.positions.get_open_positions", return_value=mock_positions
        )
    ...
    def test_get_open_positions_no_positions(self, mocker):
        ...
        mock_get_open_positions = mocker.patch(
            "brokers.alpaca.positions.get_open_positions", return_value=[]
        )
    ...
    def test_get_open_positions_api_error(self, mocker):
        # Arrange
        mock_get_open_positions = mocker.patch(
            "brokers.alpaca.positions.get_open_positions",
...
class TestGetPositionsWithoutTrailingStopLoss:
    ...
    def test_get_positions_without_trailing_stop_loss_all_have_stop_loss(self, mocker):
        ...
        mocker.patch(
            "brokers.alpaca.positions.get_current_trailing_stop_orders",
    ...
    def test_get_positions_without_trailing_stop_loss_no_positions(self, mocker):
        # Arrange
        mocker.patch("brokers.alpaca.positions.get_open_positions", return_value=[])
        mocker.patch(
            "brokers.alpaca.positions.get_current_trailing_stop_orders", return_value=[]
        )
...
class TestClosePositionsBelowThreshold:
    ...
    def test_close_positions_below_threshold_success(self, mocker):
        ...
        mock_close_position = mocker.patch(
            "brokers.alpaca.positions.trading_client.close_position", return_value=True
        )
        mocker.patch(
            "brokers.alpaca.positions.trading_client.get_all_positions",
    ...
    def test_close_positions_below_threshold_no_positions_below(self, mocker):
        ...
        mock_threshold = 0.05
        mock_close_position = mocker.patch(
            "brokers.alpaca.positions.trading_client.close_position",
            return_value=True,
        )
        mocker.patch(
            "brokers.alpaca.positions.trading_client.get_all_positions",
